...
import { filterServerTransfer, saringTransfer } from "./filter";
...
/**
 * Pemantauan surat jalan DIKIRIM di ruang gudang. Tetap terpisah dari daftar
 * transfer (keputusan pemilik proyek); keduanya berbagi lapisan features/.
 */
export default function HalamanPengiriman() {
  ...
  const filteredData = saringTransfer(daftarPengiriman, kriteria);

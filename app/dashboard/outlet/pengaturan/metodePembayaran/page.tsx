            ...
            <div className="flex justify-end">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="bg-[#FFFAF3] border-[#0A2947]/10">
                  <Link href={`/dashboard/outlet/pengaturan/metodePembayaran/${metode._id || (metode as any).id}`}>
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8">
      <div className="flex flex-col gap-3">
        <Button variant="ghost" size="sm" className="w-fit cursor-pointer px-0 text-[#0A2947]/60 hover:bg-transparent hover:text-[#0A2947] font-semibold transition-colors" onClick={() => router.push("/dashboard/outlet/pengaturan")}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <Link href="/dashboard/outlet/pengaturan/metodePembayaran/buatMetodePembayaran" className="w-full sm:w-auto">

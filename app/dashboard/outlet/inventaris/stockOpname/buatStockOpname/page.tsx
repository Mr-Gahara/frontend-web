...
export default function BuatStockOpnamePage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (res) => {
      ...
      if (newOpnameId) {
        router.push(`/dashboard/outlet/inventaris/stockOpname/${newOpnameId}`);
      } else {
        router.push("/dashboard/outlet/inventaris/stockOpname");
      }
    },
    onError: (err: any) => {
    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-8">
      ...
      <div className="flex flex-col gap-4">
        <Button
          ...
          onClick={() => router.push("/dashboard/outlet/inventaris/stockOpname")}
        >
      ...
      {isLocationEmpty && (
        <div className="rounded-2xl border border-rose-200 bg-rose-50 p-6 shadow-sm flex flex-col items-center text-center gap-4">
          ...
          <Button
            onClick={() => router.push("/dashboard/outlet/pengaturan/lokasi")}
